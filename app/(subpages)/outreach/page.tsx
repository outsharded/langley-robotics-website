    ...
    <div className="min-h-screen text-[#252622] dark:text-[#fffcf2] bg-stone-100 dark:bg-gray-800">
      ...
      <main className="p-1 mb:p-4 px-4 mb:px-10">
        <div>
          ...
          <div className="grid gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 p-2">
              
          <div className='relative group col-span-2 hover:bg-stone-200 dark:hover:bg-gray-600 rounded-lg overflow-hidden'>
                <div className="transition-opacity duration-500 ease-in-out group-hover:opacity-15 opacity-100">
                  <Image src="/2-1.png" alt="Powercut Robotics Team" width={1000} height={500} sizes="(max-width: 768px) 50wv, (max-width: 1024px) 33vw, 100vw"/>
                </div>
              ...
              <div className='relative group hover:bg-stone-200 d dark:hover:bg-gray-600 rounded-lg overflow-hidden'>
                <div className="transition-opacity duration-500 ease-in-out group-hover:opacity-15 opacity-100 aspect-square">
                  <Image src="/headshots/square.jpeg" alt="Powercut Robotics Team" width={600} height={600} sizes="(max-width: 768px) 50wv, (max-width: 1024px) 33vw, 100vw"/>
                </div>
              ...
              <div className='relative group hover:bg-stone-200 dark:hover:bg-gray-600 rounded-lg overflow-hidden'>
                <div className="transition-opacity duration-500 ease-in-out group-hover:opacity-15 opacity-100 aspect-square">
                  <Image src="/robot_in_room.jpg" alt="Powercut Robotics Team" width={600} height={600} sizes="(max-width: 768px) 50wv, (max-width: 1024px) 33vw, 100vw"/>
                </div>
