    ...
    <div className="min-h-screen text-[#252622] dark:text-[#fffcf2] bg-stone-100 dark:bg-gray-800">
      ...
      <main className="p-1 mb:p-4 px-4 mb:px-10">
        <div>
          ...
          <div className="">
            <div className="flex grow p-2 dark:hover:bg-gray-700 hover:bg-gray-300 rounded-md">
                <div className="basis-1/4 flex-1 px-2">
                <h1 className="text-2xl font-bold pb-2">Fabbers</h1>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                </p>
              </div>
              <div className="rounded-lg px-1 basis-1/2 lg:basis-1/5">
            ...
            <div className="flex p-2 dark:hover:bg-gray-700 hover:bg-gray-300 rounded-md">
              ...
              <div className="basis-1/4 flex-1 px-2">
              <h1 className="text-2xl font-bold pb-2">Mr G</h1>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                </p>
              </div>
            ...
            <div className="flex p-2 dark:hover:bg-gray-700 hover:bg-gray-300 rounded-md">
                <div className="basis-1/4 flex-1 px-2">
                <h1 className="text-2xl font-bold pb-2">Fernndidles</h1>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                </p>
              </div>
