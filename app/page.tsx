        ...
        <div className='bg-fixed bg-cover pb-14' style={{backgroundImage: 'url(/backgrounds/topography.svg)'}}>
          ...
          <div className="w-4/5 p-2 rounded-lg">
            <div className="w-full flex justify-center lg:h-[600px] 2xl:h-[800px]">
              <Image className="rounded-lg object-cover object-top opacity-80 dark:opacity-70" src="/side-pitch.png" alt="image" width="2000" height="1501" sizes="(max-width: 768px) 80vw, (max-width: 1200px) 80vw, 80vw" priority />
